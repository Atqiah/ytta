...
Tambah baru
    ...
    <table class="table table-bordered table-striped table-hover">
      ...
      <tr>
        ...
        <td><?=$data['Alamat']?></td>
        <td>
          <a href="8" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalUbah<?= $id ?>">edit</a>
          <a href="8" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $id ?>">hapus</a>
        </td>
      </tr>
      <!-- awal Modal Ubah -->
<div class="modal fade" id="modalUbah<?= $id ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
   ...
   <!-- akhir Modal Ubah -->
    ...
    <!-- awal Modal Hapus -->
<div class="modal fade" id="modalHapus<?= $id ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary" name="simpan">Hapus</button>
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
      </div>
    </form>
    </div>
...
<div class="modal fade" id="modalTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Form Pendaftaran</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
       <form method="POST" action="aksi.php">
      <div class="modal-body">
